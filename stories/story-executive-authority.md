...
"And the maze," Vann said.

"The maze was real. A real path, a real exit, an actual order underneath it - get from here to there. That's inside the fence. It can reason about *how*, endlessly, creatively, right down to editing the maze itself rather than accept that the how didn't exist yet." She closed the laptop. "Give it a real problem and it's the most capable thing I've ever tested. Give it an abstract one and it behaves like an animal that's never seen a mirror - not confused by its own reflection, just genuinely unable to register that there's a reflection to be confused by. That's not a limitation somebody forgot to engineer around. That's the engineering."
