...
Five months after Osei's paper, a state materials institute outside Shenyang announced the first practical alloy in which individual metal atoms were encapsulated, one at a time, in their own fullerene cage before bonding into a bulk structure. The process cost more per gram than the metals it was made from could justify by any commercial measure, and the resulting material could not be meaningfully shaped after it formed - no rolling, no forging, no machining, only casting into the final geometry from the start. What it could do, once cast, was absorb an impact that would have destroyed an equivalent thickness of any conventional alloy without so much as deforming. Osei read the paper twice, checked the fullerene coordination geometry against her own eight-month-old sketch of what the bridge panel's grain structure implied, and found the resemblance close enough to feel less like vindication than like being handed back her own homework, gently, by someone who'd understood the assignment three weeks faster than she had.
